            ...
            <tr>
              <td style="padding: 16px">
                <table
                  ...
                  <tr>
                    <td colspan="5" style="padding-bottom: 12px; font-family: <?php if ($type == 'venus'): ?> Open Sans <?php else: ?> Inter <?php endif ?>, Arial, sans-serif;">
                      {Product Description}
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr style="font-weight: bold">
                    ...
                    <td style="font-family: <?php if ($type == 'venus'): ?> Open Sans <?php else: ?> Inter <?php endif ?>, Arial, sans-serif;"><strong>Pack Size</strong></td>
                      <td style="font-family: <?php if ($type == 'venus'): ?> Open Sans <?php else: ?> Inter <?php endif ?>, Arial, sans-serif;"><strong>Size</strong></td>

...
<tr>
  <?php include '../components/tdstyle.html.php' ?>
    <p>
      Thank you for placing an order <?php include '../components/maintype.html.php' ?>. We will assemble all products that we have in-store and make them available for collection at <strong>{BRANCHNAME}</strong> branch, on <strong>{ORDERCOLLECTDATE}</strong> after <strong>{ORDERCOLLECTTIME}</strong>.
    </p>
  </td>
</tr>
<tr>
...
<tr>
  <?php include '../components/tdstyle.html.php' ?>
    <p>
      They will be delivered into <strong>{BRANCHNAME}</strong> branch within <strong>{BRANCHMESSAGE}</strong>, reserved for you, and invoiced separately to the rest of your order. We will contact you as soon as they are available for collection.
    </p>
  </td>
</tr>
